...
import service01 from '/assets/images/services01.svg'
import service02 from '/assets/images/services02.svg'
import service03 from '/assets/images/services03.svg'
    ...
    return (
        <div className="home-page">
            ...
            <div className="home-page-hero">
                ...
                <div>
                    <h1>Güneşin Tadını Çıkar, Tarzını Göster!</h1>
                    <p>Yaz aylarının enerjisini ve canlılığını üzerinizde taşımaya hazır mısınız? Güneşin parıltısını yansıtan renkler, hafif ve nefes alabilen kumaşlarla tasarlanmış koleksiyonumuz, her anınızı özel kılacak. Güneşin tadını çıkarırken, tarzınızla ışıldayın!</p>

                    <Link to={'/magaza'}>Alışverişe Başla</Link>
                </div>

                <video autoPlay loop muted>
                    <source src="./assets/videos/indirim.mp4" type="video/mp4"/>
                </video>

            </div>

            <div className="home-page-latest-arrivals">

                <header>
                    <h1>Yeni Ürünler</h1>
                    <Link to={'/magaza'}>Tümünü Gör</Link>
                </header>
            ...
            <div className="home-page-our-collections">

                <header>
                    <h1>Özel Koleksiyonlarımız</h1>
                </header>

                <main>
                    <div className="home-page-our-collections-left">
                        <Link to={'/magaza'}>
                            <img src="https://ktnimg2.mncdn.com/cms/2024/06/27/089b0658-d6d9-44bf-a767-471f10eb02e0.png" alt="" />
                            <div className="opacity">
                                <h3>Çocuklar için</h3>
                            </div>
                        </Link>
                    </div>
                    <div className="home-page-our-collections-right">
                        <Link to={'/magaza'}>
                            <img src="https://ktnimg2.mncdn.com/cms/2024/07/17/84251c3e-1768-4c17-876f-9822571fded0.png" alt="" />
                            <div className="opacity">
                                <h3>Kadınlar için</h3>
                            </div>
                        </Link>
                        <Link to={'/magaza'}>
                            <img src="https://ktnimg2.mncdn.com/cms/2024/05/24/87baab53-cbea-4714-ae4a-fdac6a1ef53a.png" alt="" />
                            <div className="opacity">
                                <h3>Erkekler için</h3>
                            </div>
                        </Link>
            ...
            <div className="home-page-experience">
                <h6>Deneyim</h6>
                <h3>Mükemmeliyet Tutkumuz</h3>
                <p>Her anın ve her etkileşimin, mükemmeliyete olan sarsılmaz bağlılığımızı yansıttığına inanıyoruz. Olağanüstü müşteri hizmetleri ile sizin için buradayız ve her zaman en iyisini sunmak için çaba gösteriyoruz. Hizmet kalitemizle fark yaratmak ve her ziyareti özel kılmak en büyük gurur kaynağımızdır.</p>
            </div>
            ...
            <div className="home-page-services">
                ...
                <div>
                    ...
                    <p>Tüm alışverişlerinizde ücretsiz kargo hizmetimizden faydalanabilirsiniz. Siz sadece alışveriş yapın, geri kalanını biz hallederiz!</p>
                </div>
                ...
                <div>
                    ...
                    <h3>2 Yıl Garanti</h3>
                    <p>Ürünlerimiz 2 yıl garanti süresi ile desteklenmektedir. Kalite ve güvenliği ön planda tutarak her zaman yanınızdayız.</p>
                </div>
                ...
                <div>
                    ...
                    <h3>Kolay İade</h3>
                    <p>Kolay iade sürecimizle memnun kalmadığınız ürünleri zahmetsizce geri gönderebilirsiniz. Sizi her zaman memnun etmek istiyoruz.</p>
                </div>
